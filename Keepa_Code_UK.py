...
def fetch_keepa_data(asins, access_key):
    domain_id = 2  # assuming Amazon CA
    all_coupons_data = []
...
update_database(engine, 'category_rank_history_UK', filtered_category_rank_df)
update_database(engine, 'coupon_history_UK', filtered_coupon_history_df)
update_database(engine, 'lightning_deal_UK', filtered_lightning_deal_df)
update_database(engine, 'new_price_history_UK', filtered_new_price_history_df)
update_database(engine, 'sales_history_UK', filtered_sales_history_df)
update_database(engine, 'sales_rank_UK', filtered_sales_rank_df)
