...
def fetch_keepa_data(asins, access_key):
    domain_id = 6  # assuming Amazon CA
    all_coupons_data = []
...
update_database(engine, 'category_rank_history_CA', filtered_category_rank_df)
update_database(engine, 'coupon_history_CA', filtered_coupon_history_df)
update_database(engine, 'lightning_deal_CA', filtered_lightning_deal_df)
update_database(engine, 'new_price_history_CA', filtered_new_price_history_df)
update_database(engine, 'sales_history_CA', filtered_sales_history_df)
update_database(engine, 'sales_rank_CA', filtered_sales_rank_df)
